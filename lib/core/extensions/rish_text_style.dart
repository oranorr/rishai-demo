...
TextStyle large(FontWeight fontWeight,
...
TextStyle medium(FontWeight fontWeight,
        [Color? color, TextDecoration? decoration]) =>
    RishTextStyle.font(
        fontSize: 16,
        height: 24 / 16,
...
TextStyle small(FontWeight fontWeight,
        [Color? color, TextDecoration? decoration]) =>
    RishTextStyle.font(
        fontSize: 14,
        height: 22 / 14,
...
TextStyle header(double fontSize, double height,
        [Color? color, TextDecoration? decoration]) =>
    RishTextStyle.font(
        fontSize: fontSize,
        height: height,
...
TextStyle numbers(double fontSize, double height,
        [Color? color, TextDecoration? decoration]) =>
    RishTextStyle.font(
        fontSize: fontSize,
        height: height,
